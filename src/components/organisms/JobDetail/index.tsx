...
const JobDetail: FC<JobDetailPageProps> = ({}) => {
  return (
    <div>
          ...
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                ...
                ipsa? Ratione alias quas, iusto, error quod temporibus fugit ex
                pariatur corrupti illo possimus totam veniam? Debitis fuga
                nesciunt rem? Culpa!
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="mb-10 space-y-5">
            ...
            <div className="flex justify-between">
              ...
              <div className="font-semibold">Rp 1.000.000 - Rp 3.000.000</div>
            </div>
          </div>
          ...
          <div className="my-10">
            <div className="text-3xl font-semibold mb-4">Required Skill</div>
            <div className="space-x-5">
